...
LABEL maintainer='Elnaz Azmi, Martin Laviale'
LABEL version='0.0.1'
...
# Install user app
RUN git clone -b $branch --depth 1 https://github.com/ai4os-hub/diamorph-prediction && \
    pip3 install --no-cache-dir -e ./diamorph-prediction
