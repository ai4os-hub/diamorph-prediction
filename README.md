...
[![Build Status](https://jenkins.services.ai4os.eu/buildStatus/icon?job=AI4OS-hub/diamorph-prediction/dev)](https://jenkins.services.ai4os.eu/job/AI4OS-hub/job/diamorph-prediction/job/dev/)
