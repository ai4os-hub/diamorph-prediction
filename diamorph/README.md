...
```bash
$ python -m diamorph.make_dataset {your_arguments}
$ python -m diamorph.make_model {your_arguments}
$ python -m diamorph.compare_models {your_arguments}
```
...
```bash
$ python -m diamorph.dataset.make_dataset {your_arguments}
$ python -m diamorph.models.make_model {your_arguments}
$ python -m diamorph.visualization.compare_models {your_arguments}
```
